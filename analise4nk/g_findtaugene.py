...
def cul_percent(h5ad,marker,name):
    ...
    for ctype in celltype:
        ...
        for g in genes   :
            ...
            gene_type.append(adata.var[adata.var["gene"]==g]["gene_type"].values[0])

        dict={ctype:genes,"gene_type":gene_type,"mean":mean,"per":per}
        df=pd.DataFrame.from_dict(dict,orient="index").transpose()
...
# find("../data/raw/gse212890/h5ad/tau/alltest_tau_var.csv","data/raw/gse212890/h5ad/tau/alltest_tau.h5ad",0.75)
# find(taulh,h5adlh,0.75)
# hlname="cd56hcd16l"
# lhname="cd56lcd16h"
cul_percent("../data/raw/gse212890/h5ad/tau/alltest_tau.h5ad","../data/raw/gse212890/marker/alltest_marker.csv","alltest")
