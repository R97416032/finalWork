...
def cluster(path):
    ...
    print(adata)
    marker_genes_dict = {
        'CD56brightCD16lo-c3-CCL3': ['CCL3'],
        'CD56brightCD16lo-c5-CREM': ['CREM'],
        'CD56brightCD16lo-c4-IL7R': ['IL7R'],
        'CD56brightCD16lo-c2-IL7R-RGS1lo': ['IL7R', 'RGS1'],
        'CD56brightCD16lo-c1-GZMH': ['GZMH']
    }
    ...
    sc.pp.neighbors(adata, n_neighbors=10, n_pcs=30,method='gauss',knn=True)
    sc.tl.umap(adata)
    ...
    adata.write(path.replace(".h5ad","_gauss_knn_cluster.h5ad"))
